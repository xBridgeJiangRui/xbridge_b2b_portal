...
<script>
    ...
    $(document).ready(function() {
            ...
            if (details.length > 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        user_guid: '3379ECDBDB0711E7B504A81E8453CCF0',
                    },
                    beforeSend: function() {
                        // $('.btn').button('loading');
                    },
        ...
        $(document).on('click', '#view_all', function() {
            ...
            methodd += '<div class="row"><div class="col-md-2"><b>Supplier Name</b></div> <div class="col-md-4"> <select id="supplier_name" class="form-control"> <option value="">None</option> <?php foreach ($get_supplier_name_list->result() as $row) { ?> <option value="<?php echo $row->supplier_group_name ?>"> <?php echo $row->supplier_name; ?></option> <?php } ?> </select> </div> <div class="clearfix"></div><br> <div class="col-md-2"><b>Customer Name</b></div> <div class="col-md-4"> <select id="customer_name" class="form-control"> <option value="">None</option> <?php foreach ($get_customer_name_list->result() as $row) { ?> <option value="<?php echo $row->acc_guid ?>"> <?php echo $row->acc_name; ?></option> <?php } ?> </select> </div> <div class="clearfix"></div><br></div>';
