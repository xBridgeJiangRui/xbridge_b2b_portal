...
<?php // echo var_dump($_SESSION); ?>
  <div class="col-md-12">
        <a class="btn btn-app" href="<?php echo site_url('Consignment_report/consignment_sales_statement');?>?status=<?php echo $_REQUEST['status'];?>&loc=<?php echo $_REQUEST['loc'];?>&period_code=<?php echo $_REQUEST['period_code'];?>">
