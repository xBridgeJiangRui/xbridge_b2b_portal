    ...
    <div class="col-md-12">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <form class="" role="form" action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <label for="varchar" class="col-sm-2 control-label">Branch Faxs </label>
                    <div class="col-sm-10"><?php echo form_error('branch_fax') ?>
                        <input type="text" class="form-control" name="branch_fax" id="branch_fax" placeholder="Branch Taxcode" value="<?php echo $branch_fax; ?>" required/>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-6 form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Concepts</label>
                    <div class="col-sm-10"><?php echo form_error('concept') ?>
                        <select name="concept" id="concept" class="form-control">
                            <option selected data-default style="display: none; "<?php echo $disabled ?> value="<?php echo $concept_guid ?>" ><?php echo $concept_select?></option>
                            <?php 
                            foreach ($concept as $row)
                                {
                                    ?>
                                    <option value="<?php echo $row->concept_guid ?>"><?php echo $row->concept_name?></option>
                                    <?php
                                }
                            ?>     
                        </select>
