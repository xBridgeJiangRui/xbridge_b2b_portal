        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="border-left: 1px solid black;border-right: 1px solid black;">
              ...
              <b><?php echo $reportheaderinfo->name; ?> </b>
          ...
          <tr>
            ...
            <td style="border-left: 1px solid black;border-right: 1px solid black;">
              <table>
                ...
                <td style="width: 200px"><?php echo $reportheaderinfo->address; ?> </td>
          ...
          <tr>
            ...
            <td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;">
              ...
              <table>
                ...
                <td><br><br><b>Tel:</b> <?php echo $reportheaderinfo->phone; ?>  <b>  Email:</b> <?php echo $reportheaderinfo->email; ?></td>
...
<td style="width: 40%;">
        ...
        <tbody> 
                <tr>
                  ...
                  <td style="text-align: center;border: 1px solid black;" nowrap=""><?php echo $reportheaderinfo->inv_date ?></td>
    ...
    <?php if ($reportheaderinfo->remark != '') { ?>
      <div style="border-bottom: 1px solid black" ><b>Remarks :</b><?php echo $reportheaderinfo->remark; ?></div>
    <?php } ?>
...
<table class="table table-striped" style="border-collapse: collapse; width: 100%;">
  ...
  <thead>
    <tr >
            ...
            <th style="width: 52%; text-align: center; border: 1px solid black">
              <b>Subscriptions Fee</b>
            </th>
...
<tbody>
    ...
    <tr  <?php if ($row->type == 'total_transaction') { ?> style="background-color: blanchedalmond;"  <?php } ?> >
      ...
      <td style=" <?php if ($row->type == 'total_transaction' ) { ?>border-bottom: 1px solid black;  <?php } ?> width: 52%; border-left: 1px solid black; border-right: 1px solid black;">

        <?php echo $row->description ?>
          

      </td>
      <td style=" <?php if ($row->type == 'total_transaction' ) { ?>border-bottom: 1px solid black;  <?php } ?> width: 8%; text-align: center;border-left: 1px solid black; border-right: 1px solid black;">   
      ...
      <td style=" <?php if ($row->type == 'total_transaction' ) { ?>border-bottom: 1px solid black;  <?php } ?>width: 10%; text-align: center; border-left: 1px solid black; border-right: 1px solid black;vertical-align: middle;">

        <?php echo $row->quantity ?>

      </td>
      <td style=" <?php if ($row->type == 'total_transaction' ) { ?>border-bottom: 1px solid black;  <?php } ?>width: 13%; text-align: right;border-left: 1px solid black; border-right: 1px solid black;vertical-align: middle;">

        <?php if ($row->type == 'capping_discount') {
          echo '-';
        } ?>
