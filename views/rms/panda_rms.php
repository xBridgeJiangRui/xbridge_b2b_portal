...
<br>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="col-md-12">
            <div class="row">
              <form role="form" method="POST" id="myForm" action="<?php echo site_url('panda_rms/rms_filter?code=').$b2b_doc_code;?>">
              <div class="col-md-2"><b>Ref No</b></div>
              <div class="col-md-4">
                 <input id="other_doc_refno" name="other_doc_refno" type="text" autocomplete="off" class="form-control pull-right" value="<?php echo ($refno != '') ? $refno : ''; ?>">
              </div>
              ...
              <div class="col-md-12">
                ...
                <a href="<?php echo site_url('panda_rms').'?code='.$b2b_doc_code?>" class="btn btn-default" ><i class="fa fa-repeat"></i> Reset</a>
                <!-- an F5 function -->
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Document Lists</h3> &nbsp;
 ...
 $(document).ready(function(){  
  ...
  var title = '<?php echo $title;?>';
      ...
      $('#other_doc_table').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('Panda_rms/view_table');?>",
              "type": "POST",
              "data" : {b2b_doc_code:b2b_doc_code,refno:refno,status:status,start_date:start_date,end_date:end_date,title:title},
          },
          columns: [
                    { "data": "refno" },
                    { "data": "supcode" },
...
$(function() {
  ...
  start_date = "<?php echo $start_date != '' ? $start_date : ''; ?>";
  end_date = "<?php echo $end_date != '' ? $end_date : ''; ?>";
  ...
  $(this).find('[name="other_doc_datetime"]').val(value);
});
