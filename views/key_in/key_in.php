    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"> Set Your New Password</h3><br>
      ...
      <div class="col-md-6">
      <form action="<?php echo site_url('Key_in/key_in_pass');?>" method='post'>

        <div class="form-group">
        Email Address : <input class="form-control" autocomplete="off" required id="first_password" name="d_e_a" value="<?php echo $email_address;?>" type="text" readonly />
        </div>

        <div class="form-group">
        Please Enter Password : <input class="form-control" autocomplete="off" required id="first_password" name="f_p" value="" type="password"/>
        </div>

        <div class="form-group">
        Confirm Password : <input class="form-control" autocomplete="off" required id="second_password" name="s_p" value="" type="password"/>
        </div>

        <input type="hidden" id="r_g" name="r_g" value="<?php echo $reset_guid; ?>">
        <input type="hidden" id="u_g" name="u_g" value="<?php echo $user_guid ; ?>">
        <input type="hidden" id="e_a" name="e_a" value="<?php echo $email_address; ?>">
