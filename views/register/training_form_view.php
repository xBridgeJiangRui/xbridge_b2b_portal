        ...
        <div class="box-header with-border">
          <h2 class="text-center">Training Form </h2> <br>
              <?php foreach ($training->result() as $key) {  ?>
                <a type="button" class="btn btn-xs btn-primary" style="float:right;" href="training_form_edit?training_guid=<?php echo $key->training_guid ?>"  ><i class="glyphicon glyphicon-pencil"></i></a><br>
              <?php  } ?>
          ...
          <?php } ?>-->
          <h5 style="margin-left: 15px; margin-top: 20px; ">xBridge B2B Portal Training is<span style="background-color: yellow; "> OPTIONAL</span>. If interested please complete this Training form together
              ...
              <h4 class="text-bold part1" style="margin-left: 15px; ">Part 1: Organizational Information</h4><br>
                ...
                <form action="<?php echo site_url('Training_user/register')?>" method="post">
                 <div class="form-row">
                  <div class="form-group col-md-12">
                   ...
                   <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="comp_email" name="comp_email" aria-describedby="emailHelp" value="<?php echo $key->comp_email;?>" disabled>
                      <?php } ?>
                  </div>
                  ...
                  <br><br>
                   ...
                   <div class="note" style="margin-left: 15px;margin-top: 100px;"><br>
                    ...
                    <br><br><br>
                  <div class="note2" style="margin-left: 35px;margin-top: 150px;">
                 ...
                 <h5>
                    ...
                    <button title=""  onclick="window.location='register_admin';" id="send_training_details" type="button" class="btn btn-sm btn-info"><i class=" glyphicon glyphicon-play" aria-hidden="true"></i>&nbsp&nbspProceed
                     </button>
