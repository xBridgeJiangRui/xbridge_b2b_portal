                    ...
                    <tbody>
                      ...
                      <?php 
                          ...
                          foreach($allFiles as $value)
                          {
                            ...
                            echo "<td><a href ='".site_url('CusAdmin_controller/get_download?supcus_guid=').$_REQUEST['supcus_guid']."&customer_guid=".$_REQUEST['customer_guid']."&title=".$value."' target='u_blank' download>$value</a></td>
 
                              <td><a title='del' class='btn btn-xs btn-danger' style='text-align: right' href ='".site_url('CusAdmin_controller/unlink?supcus_guid=').$_REQUEST['supcus_guid']."&customer_guid=".$_REQUEST['customer_guid']."&title=".$value."'><i class='glyphicon glyphicon-trash'></i></a></td>
                             </tr> " ;
                          }
                       ?>  
