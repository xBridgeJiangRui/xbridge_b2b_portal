...
class Sign_upload_doc extends CI_Controller
{
    ...
    public function upload_docs_list()
    {
        ...
        $defined_path_acc = './sup_doc/'.$acc_guid.'/';  
        $defined_path = './sup_doc/'.$acc_guid.'/'.$announcement_guid.'/';  
        $defined_path_1 = './sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/';
        ...
        $unlink_path = './sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/'.$file_name;
        $unlink_path_check = 'https://localhost/b2b_portal/sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/'.$file_name.'';

        // if(file_exists($unlink_path)){
        // unlink($unlink_path);
        // }

        $check_path = './sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/'.$file_name;
        ...
        $url_link = 'https://localhost/b2b_portal/sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/'.$file_name.'';
    ...
    public function upload_docs()
    {
        ...
        if($supplier_guid != 'no_data')
        {
            ...
            foreach($check_doc_upload_supplier->result() as $key )
            {
                ...
                $unlink_path = './sup_doc/'.$acc_guid.'/'.$announcement_guid.'/'.$supplier_guid.'/'.$old_file_name;
