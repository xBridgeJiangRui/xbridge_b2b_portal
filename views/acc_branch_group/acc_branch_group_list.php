    ...
    <div class="col-md-12">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <table id="acc_branch_group" class="table table-bordered table-hover" width="100%" cellspacing="0">
                    <thead>
                    <tr >
                        <th>Action</th>
                        <th>Isactive</th>
                    ...
                    foreach($details as $row)
                    {
                      ...
                      <tr>
                      <td>
                        <a title="Edit" href="<?php echo site_url('acc_branch_group/update')?>?guid=<?php echo $row->branch_group_guid?>" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil "></i></a>
